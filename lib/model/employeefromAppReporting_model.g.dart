...
_$EmployeeFromAppReportingModelImpl
    _$$EmployeeFromAppReportingModelImplFromJson(Map<String, dynamic> json) =>
        _$EmployeeFromAppReportingModelImpl(
          ...
          emailMandatorySend:
              (json['emailMandatorySend'] as num?)?.toInt() ?? 0,
          ...
          employeeAuthorizationForPlantUnitHead:
              (json['employeeAuthorizationForPlantUnitHead'] as num?)
                      ?.toInt() ??
                  0,
...
Map<String, dynamic> _$$EmployeeFromAppReportingModelImplToJson(
        _$EmployeeFromAppReportingModelImpl instance) =>
    <String, dynamic>{
