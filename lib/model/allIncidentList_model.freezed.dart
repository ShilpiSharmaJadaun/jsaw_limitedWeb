...
AllIncidentListModel _$AllIncidentListModelFromJson(Map<String, dynamic> json) {
  return _AllIncidentListModel.fromJson(json);
}

/// @nodoc
mixin _$AllIncidentListModel {
  ...
  @JsonKey(ignore: true)
  $AllIncidentListModelCopyWith<AllIncidentListModel> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $AllIncidentListModelCopyWith<$Res> {
  factory $AllIncidentListModelCopyWith(AllIncidentListModel value,
          $Res Function(AllIncidentListModel) then) =
      _$AllIncidentListModelCopyWithImpl<$Res, AllIncidentListModel>;
  @useResult
  $Res call(
      {int id,
      String uniqueId,
...
/// @nodoc
class _$AllIncidentListModelCopyWithImpl<$Res,
        $Val extends AllIncidentListModel>
    implements $AllIncidentListModelCopyWith<$Res> {
  _$AllIncidentListModelCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$AllIncidentListModelImplCopyWith<$Res>
    implements $AllIncidentListModelCopyWith<$Res> {
  factory _$$AllIncidentListModelImplCopyWith(_$AllIncidentListModelImpl value,
          $Res Function(_$AllIncidentListModelImpl) then) =
      __$$AllIncidentListModelImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {int id,
...
/// @nodoc
class __$$AllIncidentListModelImplCopyWithImpl<$Res>
    extends _$AllIncidentListModelCopyWithImpl<$Res, _$AllIncidentListModelImpl>
    implements _$$AllIncidentListModelImplCopyWith<$Res> {
  __$$AllIncidentListModelImplCopyWithImpl(_$AllIncidentListModelImpl _value,
      $Res Function(_$AllIncidentListModelImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$AllIncidentListModelImpl(
      id: null == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int,
...
/// @nodoc
@JsonSerializable()
class _$AllIncidentListModelImpl implements _AllIncidentListModel {
  const _$AllIncidentListModelImpl(
      {this.id = 0,
      this.uniqueId = "",
  ...
  factory _$AllIncidentListModelImpl.fromJson(Map<String, dynamic> json) =>
      _$$AllIncidentListModelImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$AllIncidentListModelImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$AllIncidentListModelImplCopyWith<_$AllIncidentListModelImpl>
      get copyWith =>
          __$$AllIncidentListModelImplCopyWithImpl<_$AllIncidentListModelImpl>(
              this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$AllIncidentListModelImplToJson(
      this,
    );
  }
}

abstract class _AllIncidentListModel implements AllIncidentListModel {
  const factory _AllIncidentListModel(
      {final int id,
      final String uniqueId,
      final String incidentDateTime,
      final String shift,
      ...
      final String firDateTime,
      final String imageUrl,
      final String raisedDate}) = _$AllIncidentListModelImpl;

  factory _AllIncidentListModel.fromJson(Map<String, dynamic> json) =
      _$AllIncidentListModelImpl.fromJson;
