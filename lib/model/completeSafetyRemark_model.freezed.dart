...
CompleteSafetyRemarkModel _$CompleteSafetyRemarkModelFromJson(
    Map<String, dynamic> json) {
  return _CompleteSafetyRemarkModel.fromJson(json);
}

/// @nodoc
mixin _$CompleteSafetyRemarkModel {
  ...
  String get typeOfInjury => throw _privateConstructorUsedError;
  ...
  @JsonKey(ignore: true)
  $CompleteSafetyRemarkModelCopyWith<CompleteSafetyRemarkModel> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $CompleteSafetyRemarkModelCopyWith<$Res> {
  factory $CompleteSafetyRemarkModelCopyWith(CompleteSafetyRemarkModel value,
          $Res Function(CompleteSafetyRemarkModel) then) =
      _$CompleteSafetyRemarkModelCopyWithImpl<$Res, CompleteSafetyRemarkModel>;
  @useResult
  $Res call(
      {int id,
...
/// @nodoc
class _$CompleteSafetyRemarkModelCopyWithImpl<$Res,
        $Val extends CompleteSafetyRemarkModel>
    implements $CompleteSafetyRemarkModelCopyWith<$Res> {
  _$CompleteSafetyRemarkModelCopyWithImpl(this._value, this._then);
    ...
    return _then(_value.copyWith(
      ...
      imageUrl: null == imageUrl
          ...
          : imageUrl // ignore: cast_nullable_to_non_nullable
              as String,
      typeOfInjury: null == typeOfInjury
          ? _value.typeOfInjury
          : typeOfInjury // ignore: cast_nullable_to_non_nullable
              as String,
...
/// @nodoc
abstract class _$$CompleteSafetyRemarkModelImplCopyWith<$Res>
    implements $CompleteSafetyRemarkModelCopyWith<$Res> {
  factory _$$CompleteSafetyRemarkModelImplCopyWith(
          _$CompleteSafetyRemarkModelImpl value,
          $Res Function(_$CompleteSafetyRemarkModelImpl) then) =
      __$$CompleteSafetyRemarkModelImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {int id,
...
/// @nodoc
class __$$CompleteSafetyRemarkModelImplCopyWithImpl<$Res>
    extends _$CompleteSafetyRemarkModelCopyWithImpl<$Res,
        _$CompleteSafetyRemarkModelImpl>
    implements _$$CompleteSafetyRemarkModelImplCopyWith<$Res> {
  __$$CompleteSafetyRemarkModelImplCopyWithImpl(
      _$CompleteSafetyRemarkModelImpl _value,
      $Res Function(_$CompleteSafetyRemarkModelImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$CompleteSafetyRemarkModelImpl(
      id: null == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int,
...
/// @nodoc
@JsonSerializable()
class _$CompleteSafetyRemarkModelImpl implements _CompleteSafetyRemarkModel {
  const _$CompleteSafetyRemarkModelImpl(
      {this.id = 0,
  ...
  factory _$CompleteSafetyRemarkModelImpl.fromJson(Map<String, dynamic> json) =>
      _$$CompleteSafetyRemarkModelImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$CompleteSafetyRemarkModelImpl &&
            ...
            (identical(other.typeOfInjury, typeOfInjury) ||
                other.typeOfInjury == typeOfInjury) &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$CompleteSafetyRemarkModelImplCopyWith<_$CompleteSafetyRemarkModelImpl>
      get copyWith => __$$CompleteSafetyRemarkModelImplCopyWithImpl<
          _$CompleteSafetyRemarkModelImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$CompleteSafetyRemarkModelImplToJson(
      this,
    );
  }
}

abstract class _CompleteSafetyRemarkModel implements CompleteSafetyRemarkModel {
  const factory _CompleteSafetyRemarkModel(
      {final int id,
      final int incidentReportId,
      final String incidentUniqueId,
      final String incidentDateTime,
      ...
      final String raisedDate,
      final String lowQualityImageUrl,
      final String highQualityImageUrl}) = _$CompleteSafetyRemarkModelImpl;

  factory _CompleteSafetyRemarkModel.fromJson(Map<String, dynamic> json) =
      _$CompleteSafetyRemarkModelImpl.fromJson;
