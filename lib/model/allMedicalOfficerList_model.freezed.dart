...
part of 'allMedicalOfficerList_model.dart';
...
AllMedicalOfficerListModel _$AllMedicalOfficerListModelFromJson(
    Map<String, dynamic> json) {
  return _AllMedicalOfficerListModel.fromJson(json);
}

/// @nodoc
mixin _$AllMedicalOfficerListModel {
  ...
  @JsonKey(ignore: true)
  $AllMedicalOfficerListModelCopyWith<AllMedicalOfficerListModel>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $AllMedicalOfficerListModelCopyWith<$Res> {
  factory $AllMedicalOfficerListModelCopyWith(AllMedicalOfficerListModel value,
          $Res Function(AllMedicalOfficerListModel) then) =
      _$AllMedicalOfficerListModelCopyWithImpl<$Res,
          AllMedicalOfficerListModel>;
  @useResult
  $Res call(
      {int id,
      String uniqueId,
...
/// @nodoc
class _$AllMedicalOfficerListModelCopyWithImpl<$Res,
        $Val extends AllMedicalOfficerListModel>
    implements $AllMedicalOfficerListModelCopyWith<$Res> {
  _$AllMedicalOfficerListModelCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$AllMedicalOfficerListModelImplCopyWith<$Res>
    implements $AllMedicalOfficerListModelCopyWith<$Res> {
  factory _$$AllMedicalOfficerListModelImplCopyWith(
          _$AllMedicalOfficerListModelImpl value,
          $Res Function(_$AllMedicalOfficerListModelImpl) then) =
      __$$AllMedicalOfficerListModelImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {int id,
...
/// @nodoc
class __$$AllMedicalOfficerListModelImplCopyWithImpl<$Res>
    extends _$AllMedicalOfficerListModelCopyWithImpl<$Res,
        _$AllMedicalOfficerListModelImpl>
    implements _$$AllMedicalOfficerListModelImplCopyWith<$Res> {
  __$$AllMedicalOfficerListModelImplCopyWithImpl(
      _$AllMedicalOfficerListModelImpl _value,
      $Res Function(_$AllMedicalOfficerListModelImpl) _then)
      : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$AllMedicalOfficerListModelImpl implements _AllMedicalOfficerListModel {
  const _$AllMedicalOfficerListModelImpl(
      {this.id = 0,
      this.uniqueId = "",
  ...
  factory _$AllMedicalOfficerListModelImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$AllMedicalOfficerListModelImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$AllMedicalOfficerListModelImpl &&
  ...
  _$$AllMedicalOfficerListModelImplCopyWith<_$AllMedicalOfficerListModelImpl>
      get copyWith => __$$AllMedicalOfficerListModelImplCopyWithImpl<
          _$AllMedicalOfficerListModelImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$AllMedicalOfficerListModelImplToJson(
      this,
    );
  }
}

abstract class _AllMedicalOfficerListModel
    implements AllMedicalOfficerListModel {
  const factory _AllMedicalOfficerListModel(
      {final int id,
      final String uniqueId,
      final String incidentDateTime,
      final String shift,
