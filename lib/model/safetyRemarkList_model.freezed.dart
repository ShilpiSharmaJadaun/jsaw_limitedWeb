...
SafetyRemarkListModel _$SafetyRemarkListModelFromJson(
    Map<String, dynamic> json) {
  return _SafetyRemarkListModel.fromJson(json);
}

/// @nodoc
mixin _$SafetyRemarkListModel {
  ...
  @JsonKey(ignore: true)
  $SafetyRemarkListModelCopyWith<SafetyRemarkListModel> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $SafetyRemarkListModelCopyWith<$Res> {
  factory $SafetyRemarkListModelCopyWith(SafetyRemarkListModel value,
          $Res Function(SafetyRemarkListModel) then) =
      _$SafetyRemarkListModelCopyWithImpl<$Res, SafetyRemarkListModel>;
  @useResult
  $Res call(
      {int id,
...
/// @nodoc
class _$SafetyRemarkListModelCopyWithImpl<$Res,
        $Val extends SafetyRemarkListModel>
    implements $SafetyRemarkListModelCopyWith<$Res> {
  _$SafetyRemarkListModelCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$SafetyRemarkListModelImplCopyWith<$Res>
    implements $SafetyRemarkListModelCopyWith<$Res> {
  factory _$$SafetyRemarkListModelImplCopyWith(
          _$SafetyRemarkListModelImpl value,
          $Res Function(_$SafetyRemarkListModelImpl) then) =
      __$$SafetyRemarkListModelImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {int id,
...
/// @nodoc
class __$$SafetyRemarkListModelImplCopyWithImpl<$Res>
    extends _$SafetyRemarkListModelCopyWithImpl<$Res,
        _$SafetyRemarkListModelImpl>
    implements _$$SafetyRemarkListModelImplCopyWith<$Res> {
  __$$SafetyRemarkListModelImplCopyWithImpl(_$SafetyRemarkListModelImpl _value,
      $Res Function(_$SafetyRemarkListModelImpl) _then)
      : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$SafetyRemarkListModelImpl implements _SafetyRemarkListModel {
  const _$SafetyRemarkListModelImpl(
      {this.id = 0,
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$SafetyRemarkListModelImpl &&
  ...
  _$$SafetyRemarkListModelImplCopyWith<_$SafetyRemarkListModelImpl>
      get copyWith => __$$SafetyRemarkListModelImplCopyWithImpl<
          _$SafetyRemarkListModelImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$SafetyRemarkListModelImplToJson(
      this,
    );
  }
}

abstract class _SafetyRemarkListModel implements SafetyRemarkListModel {
  const factory _SafetyRemarkListModel(
      {final int id,
      final int incidentReportId,
      final String incidentUniqueId,
      final String incidentDateTime,
