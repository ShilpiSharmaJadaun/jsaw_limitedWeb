...
AllTodayObservationModel _$AllTodayObservationModelFromJson(
    Map<String, dynamic> json) {
  return _AllTodayObservationModel.fromJson(json);
}

/// @nodoc
mixin _$AllTodayObservationModel {
  ...
  @JsonKey(ignore: true)
  $AllTodayObservationModelCopyWith<AllTodayObservationModel> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $AllTodayObservationModelCopyWith<$Res> {
  factory $AllTodayObservationModelCopyWith(AllTodayObservationModel value,
          $Res Function(AllTodayObservationModel) then) =
      _$AllTodayObservationModelCopyWithImpl<$Res, AllTodayObservationModel>;
  @useResult
  $Res call(
      {int id,
...
/// @nodoc
class _$AllTodayObservationModelCopyWithImpl<$Res,
        $Val extends AllTodayObservationModel>
    implements $AllTodayObservationModelCopyWith<$Res> {
  _$AllTodayObservationModelCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$AllTodayObservationModelImplCopyWith<$Res>
    implements $AllTodayObservationModelCopyWith<$Res> {
  factory _$$AllTodayObservationModelImplCopyWith(
          _$AllTodayObservationModelImpl value,
          $Res Function(_$AllTodayObservationModelImpl) then) =
      __$$AllTodayObservationModelImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {int id,
...
/// @nodoc
class __$$AllTodayObservationModelImplCopyWithImpl<$Res>
    extends _$AllTodayObservationModelCopyWithImpl<$Res,
        _$AllTodayObservationModelImpl>
    implements _$$AllTodayObservationModelImplCopyWith<$Res> {
  __$$AllTodayObservationModelImplCopyWithImpl(
      _$AllTodayObservationModelImpl _value,
      $Res Function(_$AllTodayObservationModelImpl) _then)
      : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$AllTodayObservationModelImpl implements _AllTodayObservationModel {
  const _$AllTodayObservationModelImpl(
      {this.id = 0,
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$AllTodayObservationModelImpl &&
  ...
  _$$AllTodayObservationModelImplCopyWith<_$AllTodayObservationModelImpl>
      get copyWith => __$$AllTodayObservationModelImplCopyWithImpl<
          _$AllTodayObservationModelImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$AllTodayObservationModelImplToJson(
      this,
    );
  }
}

abstract class _AllTodayObservationModel implements AllTodayObservationModel {
  const factory _AllTodayObservationModel(
      {final int id,
      final String observationRaisedBy,
      final String observationRaisedByEmpUnqId,
      final String uniqueIdentificationNumber,
