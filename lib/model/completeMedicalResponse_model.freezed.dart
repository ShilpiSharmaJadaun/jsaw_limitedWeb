...
part of 'completeMedicalResponse_model.dart';
...
CompleteMedicalResponseModel _$CompleteMedicalResponseModelFromJson(
    Map<String, dynamic> json) {
  return _CompleteMedicalResponseModel.fromJson(json);
}

/// @nodoc
mixin _$CompleteMedicalResponseModel {
  ...
  @JsonKey(ignore: true)
  $CompleteMedicalResponseModelCopyWith<CompleteMedicalResponseModel>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $CompleteMedicalResponseModelCopyWith<$Res> {
  factory $CompleteMedicalResponseModelCopyWith(
          CompleteMedicalResponseModel value,
          $Res Function(CompleteMedicalResponseModel) then) =
      _$CompleteMedicalResponseModelCopyWithImpl<$Res,
          CompleteMedicalResponseModel>;
  @useResult
  $Res call(
      {int id,
...
/// @nodoc
class _$CompleteMedicalResponseModelCopyWithImpl<$Res,
        $Val extends CompleteMedicalResponseModel>
    implements $CompleteMedicalResponseModelCopyWith<$Res> {
  _$CompleteMedicalResponseModelCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$CompleteMedicalResponseModelImplCopyWith<$Res>
    implements $CompleteMedicalResponseModelCopyWith<$Res> {
  factory _$$CompleteMedicalResponseModelImplCopyWith(
          _$CompleteMedicalResponseModelImpl value,
          $Res Function(_$CompleteMedicalResponseModelImpl) then) =
      __$$CompleteMedicalResponseModelImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {int id,
...
/// @nodoc
class __$$CompleteMedicalResponseModelImplCopyWithImpl<$Res>
    extends _$CompleteMedicalResponseModelCopyWithImpl<$Res,
        _$CompleteMedicalResponseModelImpl>
    implements _$$CompleteMedicalResponseModelImplCopyWith<$Res> {
  __$$CompleteMedicalResponseModelImplCopyWithImpl(
      _$CompleteMedicalResponseModelImpl _value,
      $Res Function(_$CompleteMedicalResponseModelImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$CompleteMedicalResponseModelImpl(
      id: null == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int,
...
/// @nodoc
@JsonSerializable()
class _$CompleteMedicalResponseModelImpl
    implements _CompleteMedicalResponseModel {
  const _$CompleteMedicalResponseModelImpl(
      {this.id = 0,
  ...
  factory _$CompleteMedicalResponseModelImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$CompleteMedicalResponseModelImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$CompleteMedicalResponseModelImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$CompleteMedicalResponseModelImplCopyWith<
          _$CompleteMedicalResponseModelImpl>
      get copyWith => __$$CompleteMedicalResponseModelImplCopyWithImpl<
          _$CompleteMedicalResponseModelImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$CompleteMedicalResponseModelImplToJson(
      this,
    );
  }
}

abstract class _CompleteMedicalResponseModel
    implements CompleteMedicalResponseModel {
  const factory _CompleteMedicalResponseModel(
      {final int id,
      final int incidentReportId,
      final String incidentUniqueId,
      final String incidentDateTime,
      ...
      final String raisedDate,
      final String lowQualityImageUrl,
      final String highQualityImageUrl}) = _$CompleteMedicalResponseModelImpl;

  factory _CompleteMedicalResponseModel.fromJson(Map<String, dynamic> json) =
      _$CompleteMedicalResponseModelImpl.fromJson;
