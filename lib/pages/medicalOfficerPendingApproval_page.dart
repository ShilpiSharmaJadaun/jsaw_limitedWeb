...
class MedicalOfficerPendingApprovalPage extends StatefulWidget {
  const MedicalOfficerPendingApprovalPage({super.key});

  @override
  State<MedicalOfficerPendingApprovalPage> createState() => _MedicalOfficerPendingApprovalPageState();
}

class _MedicalOfficerPendingApprovalPageState extends State<MedicalOfficerPendingApprovalPage> {
  late AllMedicalOfficerListBloc allMedicalOfficerListBloc;
  ...
  void initState() {
    ...
    allMedicalOfficerListBloc = AllMedicalOfficerListBloc(incidentService);
  ...
  _buildAllIncidentList() {
    return BlocConsumer<AllMedicalOfficerListBloc, AllMedicalOfficerListState>(
  ...
  Widget _buildContent(List<AllMedicalOfficerListModel> model) {
    return Container(
