    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            const SubPageHeader("Observation Details"),
            _buildObservation(),
            const Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            _buildInfoSection(
                              ...
                              iconColor: kcStatBlue,
                              label: "Department",
                              value: widget.stationName.toString(),
                              valueColor: kcValueDark,
                            ),
                            _buildInfoSection(
                      ...
                      Expanded(
                        child: Row(
                          children: [
                            ...
                            const SizedBox(width: 6),
                            Flexible(
                              child: _buildPillBadge(widget.priority, kcStatAmber),
                            ),
                          ],
                        ),
                      ),
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Padding(
                          padding: const EdgeInsets.symmetric(vertical: 4),
                          child: Text(
                            widget.correctiveMeasure.isEmpty ? '—' : widget.correctiveMeasure,
                            maxLines: 4,
                            overflow: TextOverflow.ellipsis,
                            style: const TextStyle(
                              fontWeight: FontWeight.w600,
